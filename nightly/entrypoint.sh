...
/src/clear_checksums.py vendor/libc-0.2.172/.cargo-checksum.json
...
/src/clear_checksums.py vendor/compiler_builtins-0.1.156/.cargo-checksum.json

cp /src/nightly/bootstrap.toml .
